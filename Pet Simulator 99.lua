...
-- Disable expensive graphics features
...
RunService:Set3dRenderingEnabled(false) -- Temporarily disable rendering
task.wait(0.5) -- Wait for changes to take effect
RunService:Set3dRenderingEnabled(true)

-- Optimize particles and decals
...
-- Continuous optimization (runs every 30 seconds)
while task.wait(30) do
    optimizeLighting()
    optimizeParts()
end

print("GPU optimization script activated. Graphics quality reduced for better performance.")
